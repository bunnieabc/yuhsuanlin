...
map '/portfolio/interactive.html' do
    run lambda { |env|
      [
        200,
        {
        ...
        File.open('public/portfolio/interactive.html', File::RDONLY)
      ]
    }
end
...
map '/portfolio/googleinternship.html' do
    run lambda { |env|
      [
        200,
        {
        ...
        File.open('public/portfolio/googleinternship.html', File::RDONLY)
      ]
    }
end
